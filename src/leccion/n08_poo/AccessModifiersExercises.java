/*
 * AccesModifiersExercises
 * En esta clase resolvemos algunos ejercicios relacionados al encapsulamiento
 * 
...
public class AccessModifiersExercises {
	...
	public static void main(String[] args) {
		...
		var person2 = new PersonEX("Fabrizio Risco Alva", 20);
		
		person2.setName("Fabrizzio Rico");
		person2.setAge(21);
		
		System.out.println(person2.getName() + " con " + person2.getAge() + " años");
		...
		var producte = new ProductEX(30.0);
		
		producte.setPrice(-20.0);
		
		System.out.println(producte.getPrice());
