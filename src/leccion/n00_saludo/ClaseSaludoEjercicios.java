...
public class ClaseSaludoEjercicios {
	...
	public static void main(String[] args) {
		...
		String nombre = scanner.nextLine(); // Espera a que coloquemos nuestro nombre para avanzar con la linea
											// sigueinte
		System.out.println("Pon tu edad");
		int edad = scanner.nextInt(); // Espera un numero para que avance a la siguiente linea
		System.out.println("Tu nombre es " + nombre + " y tu tienes " + edad + " años"); // imprime los datos que
																							// introducimos en la
																							// consola en una sola linea
		...
		/*
		 * El codigo no se ejecuta ya que main indica que es un codigo que puede ser
		 * ejecutado
		 * 
		 * El error que aparece es el siguiente Error: Main method not found in class
		 * com.estudio.examples.ClaseSaludoEjercicios, please define the main method as:
		...
		// Simplemente no ejecuta ya que no se encontro la clase con el mismo nombre del
		// archivo
	}
}
