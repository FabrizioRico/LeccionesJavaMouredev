...
package leccion.n01_variablesConstantes;
...
public class DataTypes {
	...
	public static void main(String[] args) {
		...
		/*
		 * float (mas corto que double, menos preciso, para ahorrar memoria, f al final
		 * del numero 67.8f) long (mas largo que int, para contadores grandes) byte
		 * (enteros mas pequeños, consume poca memoria)
		 */

		// Primitivos son mas rapidos pero no tienen metodos y no acepta null

		// Tambien se les conoce como wrappers, objetos o clases, estos si tienen
		// metodos y pueden aceptar null
